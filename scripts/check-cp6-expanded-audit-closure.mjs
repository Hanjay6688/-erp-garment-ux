...
requireTokens(matrix, 'complete native maintenance matrix', [
  ...
  "'expected_case_count': 180", "report['cases'].append(case)",
  ...
  'writer_first_body_entry == 45', 'compilation_only_contexts == 0',
])
...
const order = [
  ...
  'Qualify exact F G H I J K L M and N rollback under closed admission',
...
requireTokens(workflow, 'exact-H proof wiring', [
  ...
  'H_MAINTENANCE_ROLLBACK/manifest.json', "= '180'",
  'V2620H_ROLLBACK_SHA256.txt',
  "('F','RETURN','WRITER_FIRST')",
  'CP6_V2620N_RUNTIME_PROOF_V1',
  'cp6-r1-v2620n-full-schema-auth-browser-proof',

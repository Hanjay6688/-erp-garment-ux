...
const expected = {
  ...
  maintenance: ['00fb67d3d451272c6690b2ccfd3a3110499e8653f982a9354c437831cc9bfa09', 54591],
  regression: ['4ea7dcb13fa05fb0ee7cdc1e7ec51ff141dc6717548a726c3d206420e2304df3', 25668],
  matrix: ['7088c3d6ac1a6cfc0778a62c657a1b92e4c4eadcf2a9eb5f7c66a20cebefcfeb', 33818],
...
requireTokens(matrix, 'complete native maintenance matrix', [
  ...
  "'expected_case_count': 280", "report['cases'].append(case)",
...
requireTokens(workflow, 'exact-H proof wiring', [
  ...
  'H_MAINTENANCE_ROLLBACK/manifest.json', "= '280'",
  'V2620H_ROLLBACK_SHA256.txt',
  "('F','RETURN','WRITER_FIRST')",
  'CP6_V2620N_RUNTIME_PROOF_V1',
  'cp6-r1-v2620s-full-schema-auth-browser-proof',

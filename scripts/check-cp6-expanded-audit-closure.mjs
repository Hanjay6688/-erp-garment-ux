...
const expected = {
  ...
  maintenance: ['1b3b981c6f77d01799d262087115c056c7a99594dd61cc17aa6dd24079d9aa0c', 63151],
  regression: ['29609e7024b554ccd6529d7912ae07159f0ba113265050340f0ae0b66b6c2318', 26040],
  matrix: ['0e314fb1384470a44795945d5d860bb57f89c548a18551657179423dedaf9130', 34350],
...
requireTokens(matrix, 'complete native maintenance matrix', [
  ...
  "'expected_case_count': 360", "report['cases'].append(case)",
...
const order = [
  ...
  'Qualify exact F G H I J K L M N O P Q R S T U V and W rollback under closed admission',
...
requireTokens(workflow, 'exact-H proof wiring', [
  ...
  'H_MAINTENANCE_ROLLBACK/manifest.json', "= '360'",
  'V2620H_ROLLBACK_SHA256.txt',
  "('F','RETURN','WRITER_FIRST')",
  'CP6_V2620N_RUNTIME_PROOF_V1',
  'cp6-r1-v2620w-full-schema-auth-browser-proof',

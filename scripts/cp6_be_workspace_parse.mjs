...
const bundle = await build({ stdin: { contents: "export { parseConversionWorkspace, validateConversionResult } from './src/productConversion'; export { parseLaundryBdWorkspace } from './src/laundryBd'", resolveDir: root, loader: 'ts' }, bundle: true, platform: 'node', format: 'esm', write: false })

...
for (const token of ["'P': {", "'P': [", "target_name in {'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', 'AA'}"])
...
for (const token of [
  ...
  "'format':'CP6_V2620AA_RUNTIME_PROOF_V1'",
...
console.log(JSON.stringify({
  ...
  maintenance_schedules: 440, writer_body_entries: 110,
  production_go: false,
}))

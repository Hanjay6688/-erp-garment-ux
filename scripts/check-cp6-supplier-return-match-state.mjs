...
for (const token of ["'P': {", "'P': [", "target_name in {'N', 'O', 'P', 'Q', 'R', 'S', 'T'}"])
...
for (const token of [
  ...
  'PHYSICAL_DISPOSABLE_CP6_AUTH_CLONE_AFTER_V2620T',
  'CP6_M_RACE_SOURCE_GENERATION: T',
  "'format':'CP6_V2620T_RUNTIME_PROOF_V1'",

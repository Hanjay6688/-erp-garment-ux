...
KEYS=['ac','ad','ae','af','ag','ah','ai','aj','ak','al','am','an','ao','ap','aq','ar','as','at','au','av','aw','ax','ay','az','ba','bb','bc','bd','be']
...
def package():
    rows=[]
    for key in KEYS:
        [path]=sorted((SOURCES if key in('aw','ax','ay','az','ba','bb','bc','bd','be') else MIGRATIONS).glob('*_erp_v2_6_20%s_*.sql'%key))

...
assert.equal(evidence.counts.navigation_labels + 1, navMap.size)
assert.equal(evidence.counts.protected_routes + 1, pageMap.size)
...
assert.equal(rpcBoundaries.size, evidence.counts.browser_rpc_boundaries + 6)

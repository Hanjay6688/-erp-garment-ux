...
ALLOWED={
 'scripts/cp6_accessory_issue.py','scripts/cp6_accessory_issue_trial.py',
 'src/accessoryIssue.ts','src/accessoryIssue.test.ts','src/ConnectedAccessoryIssuePage.tsx','src/ConnectedAccessoryIssuePage.dom.test.tsx',

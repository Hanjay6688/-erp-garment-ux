...
AZ changes only the date of those two postings: D = greatest(E, business date of the movement's physical_at) (for an
...
def function(path,head,subs):
    ...
    assert 'invoice_recost_economic_date_v1()' in body and body.count(E_EXPR)==1,(head,'E computed once')
    return body

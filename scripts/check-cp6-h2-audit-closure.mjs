...
requireTokens(matrix, '120 successor-aware native schedules and body-entry proof', [
  "'I': ('20260910100051'", "'J': ('20260910170556'", "'expected_case_count': 120",
  ...
  "'expected': 30", 'writer_first_body_entry == 30', 'compilation_only_contexts == 0',
])

...
requireTokens(matrix, '180 successor-aware native schedules and body-entry proof', [
  "'I': ('20260910100051'", "'J': ('20260910170556'", "'expected_case_count': 180",
  ...
  "'expected': 45", 'writer_first_body_entry == 45', 'compilation_only_contexts == 0',
])

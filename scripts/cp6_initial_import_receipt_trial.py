...
def truth(cur):
    names=('V267_GRNI_GL_SUBLEDGER_MISMATCH','V267_AP_GL_SUBLEDGER_MISMATCH','V267_ESTIMATED_RECEIPT_MISSING_GRNI_RECLASS',
           ...
           'V2620N_SUPPLIER_CENT_FACT_LEDGER','V2620U_JOURNAL_REVERSAL_BUSINESS_DATE',
           'V2620T_MATERIAL_ADJUSTMENT_REVALUATION','V2620T_MATERIAL_ADJUSTMENT_FACT_LEDGER',
           'V2620O_SUPPLIER_RETURN_ALLOCATION','V2620P_SUPPLIER_RETURN_MATCH_STATE',
           'V2620M_PAYMENT_SOURCE_JOURNAL_MISMATCH','V2620M_ORPHAN_PAYMENT_JOURNAL')

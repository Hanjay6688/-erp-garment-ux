...
for (const token of ["'O': {", "'O': [", "target_name in {'N', 'O'}"])
...
for (const token of [
  ...
  'Qualify exact F G H I J K L M N and O rollback',
...
for (const token of [
  ...
  'PHYSICAL_DISPOSABLE_CP6_AUTH_CLONE_AFTER_V2620O',
  'CP6_M_RACE_SOURCE_GENERATION: O',

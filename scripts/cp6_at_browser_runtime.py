...
def main():
    ...
    try:
        ...
        run('python','scripts/cp6_at_browser_fixture.py','seed')
        values={}
        ...
        result=subprocess.run(['node','scripts/cp6_at_browser_ui.mjs'],env=env,check=False)

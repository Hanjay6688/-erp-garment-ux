...
const orderedWorkflowTokens = [
  ...
  'Confirm every broad regression ran on the installed E plus F runtime',
  ...
  'Prove both live v2.6.20f rollback and business-writer lock orders',
...
requireTokens(workflow, 'A04 exact final-runtime proof', [
  ...
  'V2620F_LIVE_ROLLBACK_RACES.log',
  'V2620F_LIVE_ROLLBACK_WRITER_FIRST.json',
  'V2620F_LIVE_ROLLBACK_ROLLBACK_FIRST.json',
  "'format':'CP6_V2620F_RUNTIME_PROOF_V1'",
  "'actual_business_facade_rollback_race_orders':6",
  "'v2620f_rollback_race_orders':2",

...
const orderedWorkflowTokens = [
  ...
  'Confirm every broad regression ran on the installed E through H runtime',
  ...
  'Qualify exact F G and H rollback under closed admission across sixty native schedules',
...
requireTokens(workflow, 'A04 exact final-runtime proof', [
  ...
  "proof/'CP6_V2620H_RUNTIME_MANIFEST.json'",
  'name: cp6-r1-v2620h-full-schema-auth-browser-proof',

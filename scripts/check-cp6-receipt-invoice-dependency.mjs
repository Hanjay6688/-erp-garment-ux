...
for(const token of ['INVOICE_POST_FIRST','RECEIPT_REVERSE_FIRST','pg_blocking_pids(pid)','contender_business_boundary_unchanged',"matrix.verify_setup_source('U')"]) assert.ok(races.includes(token),token)

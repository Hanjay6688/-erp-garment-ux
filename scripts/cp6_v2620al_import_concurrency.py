...
import psycopg
import cp6_v2620al_import_review as review
import cp6_v2620h_maintenance_rollback_matrix as matrix

ROOT=Path('cp6-proof/writer-al/import-concurrency')
   ...
   for commit in (True,False):
    ...
    try:
     with psycopg.connect(CLONE) as seed,seed.cursor() as cur:
      ...
      payload['qty']='20'
     first=psycopg.connect(CLONE,application_name='al-import-first')
     second=psycopg.connect(CLONE,application_name='al-import-second')

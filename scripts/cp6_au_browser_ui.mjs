...
assert.equal(process.env.CP6_AU_BROWSER_CONFIRM,'cp6_rollback')
const pg='postgresql://postgres:postgres@127.0.0.1:54322/cp6_rollback'
const root=process.cwd(), dir=resolve('cp6-proof/au-browser'), origin='http://127.0.0.1:4176', api='http://127.0.0.1:54328'
...
const native=(mode,...args)=>JSON.parse(execFileSync('python',['scripts/cp6_au_browser_fixture.py',mode,...args],{encoding:'utf8',stdio:['ignore','pipe','pipe']}))
let fixture

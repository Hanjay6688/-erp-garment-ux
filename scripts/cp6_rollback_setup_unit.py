...
SOURCE_GENERATIONS = ('I', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T')
PLANS = {
...
def run() -> dict:
    ...
    for source, target in (('I', 'J'), ('H', 'F'), ('N', 'O'), ('O', 'P'), ('P', 'Q'), ('Q', 'R'), ('R', 'S'), ('S', 'T'), ('J', 'K'), ('K', 'L'), ('L', 'M'), ('M', 'N')):
    ...
    return {
        ...
        'status': 'PASS', 'expected_case_count': 134, 'completed_case_count': len(cases),
        'cases': cases,

...
requireTokens(matrix, '200 native schedules and body-entry proof', [
  ...
  "'J': ('20260910170556'", "'expected_case_count': 240",
  "'expected': 60", 'writer_first_body_entry == 60',
...
requireTokens(setupUnit, 'generation setup failure regressions', [
  ...
  "'expected_case_count': 89", 'unconditional_j_negative_control_rejected',

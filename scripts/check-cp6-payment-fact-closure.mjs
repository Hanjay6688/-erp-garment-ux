...
requireTokens(matrix, '200 native schedules and body-entry proof', [
  ...
  "'J': ('20260910170556'", "'expected_case_count': 340",
...
requireTokens(setupUnit, 'generation setup failure regressions', [
  ...
  "'expected_case_count': 169", 'unconditional_j_negative_control_rejected',
...
const order = [
  ...
  'Qualify exact F G H I J K L M N O P Q R S T U and V rollback under closed admission across three hundred twenty native schedules',
...
requireTokens(workflow, 'exact-J artifact contract', [
  ...
  "('F','G','H','I','J','K','L','M','N','O','P','Q','R','S','T','U','V')", "len(schedules['cases'])==340",
  "'writer_first_backend_body_entries':85",
  "'writer_first_compilation_only_contexts':0",
  "'format':'CP6_V2620N_RUNTIME_PROOF_V1'",
  "proof/'CP6_V2620V_RUNTIME_MANIFEST.json'",
  'name: cp6-r1-v2620v-full-schema-auth-browser-proof',

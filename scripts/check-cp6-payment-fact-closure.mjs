...
requireTokens(matrix, '140 native schedules and body-entry proof', [
  ...
  "'J': ('20260910170556'", "'expected_case_count': 140",
  "'expected': 35", 'writer_first_body_entry == 35',
...
requireTokens(setupUnit, 'generation setup failure regressions', [
  ...
  "'expected_case_count': 34", 'unconditional_j_negative_control_rejected',
...
requireTokens(workflow, 'exact-J artifact contract', [
  ...
  "setup_unit['completed_case_count']==setup_unit['expected_case_count']==34",

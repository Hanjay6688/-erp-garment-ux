...
requireTokens(matrix, '120 native schedules and body-entry proof', [
  ...
  "'J': ('20260910170556'", "'expected_case_count': 120",
  "'expected': 30", 'writer_first_body_entry == 30',
...
requireTokens(setupUnit, 'generation setup failure regressions', [
  ...
  "'expected_case_count': 25", 'unconditional_j_negative_control_rejected',
...
const order = [
  ...
  'Qualify exact F G H I J and K rollback under closed admission across one hundred twenty native schedules',
...
requireTokens(workflow, 'exact-J artifact contract', [
  ...
  "setup_unit['completed_case_count']==setup_unit['expected_case_count']==25",
  ...
  "('F','G','H','I','J','K')", "len(schedules['cases'])==120",
  "'writer_first_backend_body_entries':30",
  "'writer_first_compilation_only_contexts':0",
  "'format':'CP6_V2620K_RUNTIME_PROOF_V1'",
  "proof/'CP6_V2620K_RUNTIME_MANIFEST.json'",
  'name: cp6-r1-v2620k-full-schema-auth-browser-proof',
  'runtime=v2.6.20e+v2.6.20f+v2.6.20g+v2.6.20h+v2.6.20i+v2.6.20j',
  "'uat_v2620j_state':'NOT_TESTED_OR_APPLIED_BY_THIS_RUN'",
  "'production_go':False",
])
assert.ok(read('scripts/cp6_auth_permission_e2e.mjs').includes('AFTER_V2620K'))
...
console.log(JSON.stringify({
  ...
  maintenance_matrix_schedules: 120,
  writer_first_backend_body_entries: 30,
  production_go: false,
}))

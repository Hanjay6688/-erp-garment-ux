-- T3 release variant of supabase/rollbacks/20260916050822_erp_v2_6_20ag_cp6_sale_reservation_lineage.rollback.sql (sha256 c1265acfb790a8c7f2b6bc8d6b3691902658eb1f0b879ea2c1269d6e24a2f231), built by scripts/cp6_t3_rollback_acav.py from docs/evidence/cp6-t3/release_pins.json.
     ...
     or not exists(select 1 from supabase_migrations.schema_migrations
       where version='20260916050822' and name='erp_v2_6_20ag_cp6_sale_reservation_lineage'
         and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
           in('085b84cb6917617c5e6a2d375fd5177542ebe3f021a20de48e239159e34d66c0'))

-- T3 release variant of supabase/rollbacks/20260916090022_erp_v2_6_20ai_cp6_work_source_lineage.rollback.sql (sha256 ea7798456883773d53f747003017903305ee32b4d3b6f5851b17de443630ded7), built by scripts/cp6_t3_rollback_acav.py from docs/evidence/cp6-t3/release_pins.json.
     ...
     or not exists(select 1 from supabase_migrations.schema_migrations
       where version='20260916090022' and name='erp_v2_6_20ai_cp6_work_source_lineage'
         and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
           in('1ea5a602c5a5fcc9697355d9cca526709a06ee20e4eb4cdb765b2b7345c18d25'))

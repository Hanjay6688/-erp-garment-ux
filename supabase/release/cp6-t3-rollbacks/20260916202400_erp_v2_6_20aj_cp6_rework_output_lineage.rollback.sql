-- T3 release variant of supabase/rollbacks/20260916202400_erp_v2_6_20aj_cp6_rework_output_lineage.rollback.sql (sha256 896baab52089adf56c60562cf3161391e01392aec972b48408752fc4e417aed9), built by scripts/cp6_t3_rollback_acav.py from docs/evidence/cp6-t3/release_pins.json.
     ...
     or not exists(select 1 from supabase_migrations.schema_migrations
       where version='20260916202400' and name='erp_v2_6_20aj_cp6_rework_output_lineage'
         and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
           in('b36a6359c57ad59d93ea5cb8dc5f7e90a0dd9cd59d48c331b037aa365d400986'))

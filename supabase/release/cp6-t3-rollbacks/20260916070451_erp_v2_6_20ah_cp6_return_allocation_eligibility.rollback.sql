-- T3 release variant of supabase/rollbacks/20260916070451_erp_v2_6_20ah_cp6_return_allocation_eligibility.rollback.sql (sha256 aec93e99065e7197c7fcbab8b42f0b5b2ab50a2f9cc216436ae61ff854044a71), built by scripts/cp6_t3_rollback_acav.py from docs/evidence/cp6-t3/release_pins.json.
     ...
     or not exists(select 1 from supabase_migrations.schema_migrations
       where version='20260916070451' and name='erp_v2_6_20ah_cp6_return_allocation_eligibility'
         and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
           in('ade908ca9f55b2333c5eac5793b41aaabe0d57879dbb233e428fc882bab5738b'))

...
begin;
-- Built by scripts/cp6_t3_awx_release.py from supabase/dev/cp6_ay_t1_family.sql (sha256 29b8977613012431b9efa927c7cee10654aef8a016368a0430e7c3789070af43): the T1 body below is unchanged apart from the
...
from unnest(array['erp.sync_po_hpp_to_gl(uuid,date)','erp.rebuild_po_hpp(uuid,text)']) i(identity)

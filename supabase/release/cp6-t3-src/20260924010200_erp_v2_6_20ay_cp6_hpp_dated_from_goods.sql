...
begin;
-- Built by scripts/cp6_t3_awx_release.py from supabase/dev/cp6_ay_t1_family.sql (sha256 7401baf4697c78da76f2844915d929b10e334bd85356738d8d94359db2df88ce): the T1 body below is unchanged apart from the

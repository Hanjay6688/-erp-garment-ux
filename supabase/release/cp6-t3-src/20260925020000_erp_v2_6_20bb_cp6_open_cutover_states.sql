...
begin;
-- Built by scripts/cp6_t3_awx_release.py from supabase/dev/cp6_bb_t1_family.sql (sha256 a423268697f9290d7278bd98a364f9207562769c277d036ccf1c31902bbdf142): the T1 body below is unchanged apart from the

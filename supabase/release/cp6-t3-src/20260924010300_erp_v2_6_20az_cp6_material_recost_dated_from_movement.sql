...
begin;
-- Built by scripts/cp6_t3_awx_release.py from supabase/dev/cp6_az_t1_family.sql (sha256 9a8b54107323bd1a2271eb7e84bddf8829cd30a4acacc5b041ba1e15f93fe8b2): the T1 body below is unchanged apart from the

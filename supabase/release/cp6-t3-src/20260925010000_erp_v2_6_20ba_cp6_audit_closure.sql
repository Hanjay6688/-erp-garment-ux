...
begin;
-- Built by scripts/cp6_t3_awx_release.py from supabase/dev/cp6_ba_t1_family.sql (sha256 dd95bbdfb76c049bf9cfeb476ac49ae7e6ba6890d5406dc3bddd998a4443d52c): the T1 body below is unchanged apart from the

     ...
     or not exists(select 1 from supabase_migrations.schema_migrations
       where version='20260921214120' and name='erp_v2_6_20am_cp6_transfer_integrity'
         and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
           in('d5b155edb19aa8ca949036ba8a9cf67090478083c2e1ae6cc5bbf00b445716a5','21dbca365ba53a81672762ff0e1a8ccf4c430cea5a02c8bbdf4776a56632d56c'))
...
where version='20260921214120'
  ...
  and encode(extensions.digest(convert_to(array_to_string(statements,E'\n'),'UTF8'),'sha256'),'hex')
    in('d5b155edb19aa8ca949036ba8a9cf67090478083c2e1ae6cc5bbf00b445716a5',
       '21dbca365ba53a81672762ff0e1a8ccf4c430cea5a02c8bbdf4776a56632d56c');

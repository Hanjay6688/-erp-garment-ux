-- CP6 AW close readiness engine: T1_FAMILY development install (NOT a release package).
...
insert into erp.schema_migrations(version,description) values('v2.6.20aw','T1_FAMILY development install of the AW close readiness engine; not a release package');
commit;

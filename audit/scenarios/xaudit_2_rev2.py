"""rev2 (r8): rounding oracle = half away from zero (M:485 example 5,63/5,62; contract sets no banker's rounding); rev1 used Decimal default HALF_EVEN -> false COUNTEREXAMPLE on the DOWN cases.
...
def invoice_rounding(cur,today,p0,p1):
    ...
    expected_wip=str(Decimal(p1).quantize(Decimal('0.01'),rounding=ROUND_HALF_UP))

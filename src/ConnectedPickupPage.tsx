...
export default function ConnectedPickupPage() {
  ...
  useEffect(() => {
    ...
    setContractorId(selected.pickup?.contractor_id ?? queue?.contractors[0]?.id ?? '')

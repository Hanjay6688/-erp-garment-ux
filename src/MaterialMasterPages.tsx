...
const fabricSeeds:FabricMaster[]=[
  ...
  {id:'fab-zodiak',code:'FAB-ZODIAK-KW',name:'Zodiak KW',family:'Denim Light',defaultUom:'yard',active:true,rowVersion:8,benchmark:[{id:'bp-zdk-04',amount:47_250,effectiveFrom:'2026-07-01',note:'Benchmark Q3',status:'CURRENT'}]},
]
...
function FabricWorkspace(){
  ...
  const saveBenchmark=()=>{
    ...
    setBenchmarkOpen(false);setNotice(`Benchmark ${money(amount)}/yard tersimpan sebagai simulasi. Receipt berikutnya boleh memakai estimate ini; invoice final tetap menang.`)
  }
...
function AccessoryWorkspace(){
  ...
  return <>
    <MasterHero kind="AKSESORI" title="Aksesori, UOM & Harga Mandor" description="BOM kerja memakai kategori; pembelian, stok, HPP, dan Nota Ambil Mandor memakai barang detail. UOM dan harga jual punya versi efektif sendiri."/>

\set QUIET 1
\pset footer off
-- Reversed pocket-fabric usage (GPT audit AB-01): the same write-off, registered in pocket_fabric_usage (no pocket period).
...
insert into erp.pocket_fabric_usage values('00000000-0000-0000-0000-0000000000d0');

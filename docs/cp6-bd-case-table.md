...
- `COUNTEREXAMPLE` (D07 dan D09): pada rantai tanpa BD, alarm v2.5.5 per gerakan berbunyi pada buku yang tepat (temuan lama F2, diperbaiki D07), dan barang titipan yang sama diterima lagi dengan kunci baru (batas lama ACC-C12, diperbaiki D09).

Kolom *after* selalu `PASS`.

## T1 probe (`scripts/cp6_bd_probe.py`, 31 kasus, `.github/workflows/cp6-bd-t1-probe.yml`)
...
| T24:MULTI_SIZE_LOT_HPP | LAU-T24, T26, LAU-DEC05, LAU-T16 (HPP lot per ukuran) | F §LAU-T24/T26/T16; G (M:4362, 4364, 4354); owner D10: satu kiriman BD dua ukuran (6 × 8.000 tarif ukuran vendor, 4 × 5.000 tarif dasar); tiap lot memakai tarif ukurannya sendiri (8.010 dan 5.010 per potong, bukan rata-rata 6.800); selisih invoice 70.000 − 68.000 dari satu sumber tagihan dibagi per potong (1.200 dan 800), tidak menurut tarif ukuran | NO_ROUTE |
| D10:VARIANCE_BY_BILLING_SOURCE | LAU-T16, LAU-DEC06 (owner D10) | owner D10: satu grup 6 + 4 potong, ukuran 1 ke vendor A proses P dan ukuran 2 ke vendor B proses Q; invoice vendor A 32.000 untuk 6 potong (estimasi 30.000): lot vendor A +2.000, lot vendor B tetap, WIP tidak bersisa | NO_ROUTE |
| T32:REPLAY_ACCESS_GRANTS | LAU-T32, T33 (jalur BD) | F §LAU-T32/T33; G (M:4370–4371) | NO_ROUTE |
| T16:INVOICE_ABOVE_ESTIMATE_PRODUCT_COST | LAU-T16, T10 | F §LAU-T16/T10; G (M:4354, 4348); ditambah 26 Sep 2026: tidak ada cek kebenaran yang naik | NO_ROUTE |
...
| T22:VARIANCE_TO_FG_AND_COGS | LAU-T22 | F §LAU-T22; G (M:4360); ditambah 26 Sep 2026: tidak ada cek kebenaran yang naik (sebelum perbaikan `V2620C_WIP_SOURCE_CONSERVATION_MISMATCH` naik 0 → 1) | NO_ROUTE |
| DEC04:SALE_UNKNOWN_LAUNDRY_PRICE | LAU-04, LAU-T34, LAU-DEC04 (keputusan owner no. 11: `ALLOW_PENDING`) | F §LAU-T34; lampiran C6 rev4 LAU-DEC04 (M:4475); no. 11: penjualan jalan, lot hanya memuat bagian harga yang diketahui dan tampil "HPP belum final", penjualan tercatat belum final bersama versi kebijakannya, tutup buku tertahan; harga diisi → lot +10.000, stok +8.000, HPP penjualan +2.000 dalam transaksi yang sama, penahan hilang, penjualan tampil "dihitung ulang" (HPP saat dijual tetap tersimpan) | NO_ROUTE |
...
| D09:ACC_C12_SOURCE_IDENTITY | ACC-C12 (owner D09, opsi a; bukan ID laundry, dibawa BD) | owner D09: tanpa rujukan / dua bentuk / lembar tanpa baris ditolak `BC_C12_SOURCE_REQUIRED`; lembar S baris 1 dan 2 serta lot L diterima (3 + 2 + 4, tanpa jurnal); barang sama dengan kunci baru ditolak per baris lembar (huruf besar/kecil dan spasi diabaikan) dan per lot, juga dua kali dalam satu batch (`BC_C12_SAME_SOURCE`); replay kunci sama dan replay permintaan FINALIZE yang sama tidak menambah qty/jurnal; baris 3 lembar yang sama dan lot lain diterima | COUNTEREXAMPLE (rantai BC: barang sama dengan kunci baru diterima, 3 → 6) |
| D12:CLAIM_CREDIT_DAILY_OLDER_INVOICE | D12 (owner 26 Sep 2026: kredit klaim memotong tagihan belum lunas vendor yang sama, termasuk yang lebih tua) | Contoh owner dengan bulan nyata: Juni kirim 5 PCS dan invoice INV-JUN 10.000.000; Juli 1 dari 5 PCS hilang, klaim MISSING (sesudah invoice); September klaim disetujui 2.000.000 (AP 10.000.000 → 8.000.000), kredit dipakai ke invoice Juni dan kas 8.000.000: invoice PAID, kas 8.000.000 + kredit 2.000.000, sisa 0; layar pembayaran dan buku besar cocok (AP 0 = sisa 0 − kredit tersisa 0); replay tidak menambah; pemakaian kedua (`BD_CLAIM_CREDIT_EXCEEDS_AVAILABLE`) dan kas lebih ditolak; klaim tidak bisa dibatalkan selama kreditnya dipakai (`BD_CLAIM_CREDIT_IN_USE`); membatalkan pemakaian membebaskan kredit (sisa 2.000.000, tetap cocok) lalu dipakai lagi; AP akhir Juni dan semua baris jurnal Juni tidak berubah; pemeriksaan V2620C/V2620Y/V2620L/V2620M tidak bertambah | NO_ROUTE |
| D12:CLAIM_CREDIT_OPENING_OLDER_PAYABLE | D12, klaim saldo awal | Tagihan saldo awal INV-LAMA 10.000.000 (40 hari lalu), klaim MISSING 1 (12 hari lalu, sebelum cutover), disetujui 2.000.000 sesudah cutover; kredit dipakai ke tagihan lama dan kas 8.000.000: saldo awal SETTLED (kas 8.000.000 + kredit 2.000.000, sisa 0), layar dan buku besar cocok (AP 0); pemakaian kedua dan pembatalan klaim selama kreditnya dipakai ditolak; buku sampai cutover tidak berubah; pemeriksaan V2620M tidak bertambah | NO_ROUTE (impor klaim laundry belum dikenal) |
| DEC06:CORRECTION_DOCUMENT_UP_AND_DOWN | LAU-DEC06, LAU-T23 (keputusan owner no. 13, 26 Sep 2026) | Invoice A 70.000 lunas (60 hari lalu); hari ini koreksi naik +2.000 tertaut ke A = tagihan baru 2.000 (A tetap PAID, pembayarannya utuh), lot +2.000 → stok barang jadi +1.200 dan HPP penjualan +800 (4 dari 10 terjual), WIP tetap; koreksi turun 3.000 ditolak `BD_CORRECTION_EXCEEDS_PAYABLE` (utang hanya 2.000), turun 80.000 ditolak `BD_CORRECTION_BELOW_ZERO`; turun 1.500 → utang 500, lot −1.500 (stok −900, HPP penjualan −600), kreditnya melunasi 1.500 koreksi naik lalu kas 500; baris tagih + koreksi dalam satu dokumen ditolak `BD_CORRECTION_SEPARATE_DOCUMENT`; pemakaian kedua ditolak; koreksi terpakai tidak dapat dibatalkan; histori hari A tidak berubah; tidak ada cek kebenaran yang naik; kontrol negatif: selisih yang dirusak 1 rupiah membunyikan `V2620C_WIP_SOURCE_CONSERVATION_MISMATCH` | NO_ROUTE |
| DEC06:CORRECTION_DOWN_SETTLES_ORIGIN_THEN_OLDER | LAU-DEC06 (no. 13), D12 jalur kredit | Vendor punya hutang saldo awal INV-LAMA 10.000.000 dan invoice B 70.000 dibayar 69.000; koreksi turun 3.000 atas B melunasi sisa B 1.000 (B PAID: kas 69.000 + kredit koreksi 1.000), sisa kredit 2.000 dipakai untuk hutang saldo awal yang lebih tua (sisa 9.998.000, jenis `VENDOR_CORRECTION_APPLY`); layar dan buku besar cocok di tiap langkah; koreksi terpakai tidak dapat dibatalkan; membatalkan kedua pemakaian lalu koreksinya memulihkan utang dan WIP persis; histori sebelum cutover tidak berubah; tidak ada cek kebenaran yang naik | NO_ROUTE |
...
| Kasus | ID | Oracle pra-kode |
|---|---|---|
| BD_BROWSER:D12_PAYMENT_SCREEN_DAILY_CLAIM | D12 (kredit klaim lintas tagihan), klaim harian | Owner 26 Sep 2026: 2 PCS ke vendor baru (10.000.000 per PCS), 1 kembali dan ditagih INV 10.000.000; potongan lain diklaim MISSING sesudah invoice dan disetujui 2.000.000. Di layar "Pembayaran vendor" owner memakai kredit klaim 2.000.000 dan membayar kas 8.000.000: baris invoice menampilkan kas 8.000.000, kredit klaim 2.000.000, sisa 0, "Lunas"; pencocokan "Cocok"; AP vendor 0; halaman tidak bergeser ke samping |
| BD_BROWSER:D12_PAYMENT_SCREEN_OPENING_CLAIM | D12, klaim saldo awal | Tagihan saldo awal INV-LAMA 10.000.000 (40 hari lalu) dan klaim 1 dari 8 potong (12 hari lalu, sebelum cutover); klaim disetujui 2.000.000 sesudah cutover; di layar yang sama kredit klaim 2.000.000 + kas 8.000.000 melunasi tagihan lama (SETTLED, sisa 0, "Lunas", "Cocok", AP 0) |
| BD_BROWSER:DEC06_CORRECTION_UP_DOWN_ON_SCREEN | LAU-DEC06 (keputusan owner no. 13) | 1 PCS ke vendor baru (7.000), invoice INV 7.000 dibayar lunas (fixture RPC); dari layar Invoice owner memposting koreksi naik +2.000 dan turun −1.500 yang tertaut ke INV (sumbernya baris INV); dari layar Pembayaran kredit koreksi turun melunasi 1.500 koreksi naik dan kas 500: baris koreksi naik "(koreksi naik atas INV)", kredit koreksi Rp 1.500,00, kas Rp 500,00, "Lunas"; baris kredit "(koreksi turun atas INV)"; "Cocok", AP 0; INV tetap PAID dengan satu pembayaran kasnya; tanpa geser samping. Dijalankan paling akhir (mengambil 1 PCS) |
| BD_BROWSER:LAU_T36_PHONE_MIXED_COVERAGE | LAU-T36, LAU-T05, LAU-T12 | Lampiran C6 LAU-T36 (UI laundry desktop/HP): di layar HP 390 px owner menyetel vendor harga komponen dari bagian "Harga vendor" (GAR diketahui 5.000,00; SPR belum diketahui), mengirim 2 PCS dari "Kirim dengan harga" dengan cakupan GAR 2 dan SPR 1 (subtotal diketahui 10.000,00, belum lengkap), melihat SPR "Belum diketahui", lalu mengisi SPR 3.000,00 dari "Harga belum diketahui" (13.000,00, lengkap; akrual yang diinginkan = yang dibukukan). Halaman tidak boleh bergeser ke samping di setiap bagian. Pemakaian desktop tab yang sama dicakup kasus browser BD lainnya. Baris tagihan kiriman harus persis `T36 GAR:2:KNOWN,T36 SPR:1:UNKNOWN` (urutan baris); nama yang tampil harus nama tersimpan komponen vendor itu dengan kode `GAR` dan `SPR`, dicocokkan lewat SQL (tautan `ref_id`), dan harga yang diisi di HP adalah milik `SPR`. Pembanding lama (kode `GAR:2:KNOWN,…`) dikoreksi atas izin owner 26 Sep 2026; run 36218676593 dan 36219655269 tetap FAIL (handoff §34.9) |
...
- **HPP lot multi-ukuran.** Punya kasus sendiri (`T24:MULTI_SIZE_LOT_HPP`). Pembagian selisih invoice diputuskan owner D10 (26 Sep 2026): dalam layanan/tarif yang sama menurut jumlah potong; vendor/proses/paket berbeda dipisah menurut sumber tagihannya (`D10:VARIANCE_BY_BILLING_SOURCE`); tidak ada pembagian menurut tarif ukuran. Hasil run 36209582054 tetap tercatat apa adanya.
